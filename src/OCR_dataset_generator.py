...
def apply_perspective_transform(img, max_shift=10):
...
def augment_image(img):
    img = img.rotate(np.random.uniform(-10, 10), expand=False, fillcolor=100) # Rotation
...
if __name__ == '__main__':
    ...
    for _ in range(num_examples):
        ...
        imag = Image.new("L", (350, 100), color=230)
        draw = ImageDraw.Draw(imag)
        draw.text((30, 20), plate_text, font=font, fill=50)
